...
public class PrivacyController {
    ...
    public ResponseEntity<Object> has(@PathVariable Long userId, @PathVariable String scope){
    ...
    public ResponseEntity<Object> revoke(@PathVariable Long userId, @PathVariable String scope) {
    ...
    public ResponseEntity<Object> requestExport(@PathVariable Long userId) {
    ...
    public ResponseEntity<Object> requestDelete(@PathVariable Long userId) {
    ...
    public ResponseEntity<Object> start(@PathVariable long requestId) {
    ...
    public ResponseEntity<Object> complete(@PathVariable long requestId, @RequestBody CompletePayload p) {
    ...
    public ResponseEntity<Object> reject(@PathVariable long requestId, @RequestBody RejectPayload p) {
    ...
    public ResponseEntity<Object> registerConsentVersion(@RequestParam String scope, @RequestParam String version, @RequestParam String text) {
    ...
    public ResponseEntity<Object> changeVisibility(@PathVariable Long userId, @RequestBody VisibilityChangePayload p) {
