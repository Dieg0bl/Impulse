import { ChallengeResponseDto, EvidenceResponseDto } from "../types/dtos";
...
const mockStore = {
  ...
  listEvidences: (challengeId: string) =>
    evidences[challengeId] ? Promise.resolve(evidences[challengeId].slice()) : Promise.resolve([]),
};
