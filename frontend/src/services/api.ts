...
const BASE = import.meta.env.VITE_API_BASE || import.meta.env.VITE_API_URL || 'http://localhost:8080'
...
export const authApi = {
  ...
  register: async (data: RegisterRequestDto): Promise<UserResponseDto> => {
    const response = await http.post<ApiResponseDto<UserResponseDto>>('/api/v1/auth/register', data)
    return response.data.data!
  },

  refreshToken: async (refreshToken: string): Promise<LoginResponseDto> => {
    const response = await http.post<ApiResponseDto<LoginResponseDto>>('/api/v1/auth/refresh', { refreshToken })
    return response.data.data!
  },
...
export const userApi = {
  getUsers: async (params?: PageRequestDto): Promise<PageResponseDto<UserResponseDto>> => {
    const response = await http.get<ApiResponseDto<PageResponseDto<UserResponseDto>>>('/api/v1/users', { params })
    return response.data.data!
  },
...
export const challengeApi = {
  getChallenges: async (params?: PageRequestDto): Promise<PageResponseDto<ChallengeResponseDto>> => {
    const response = await http.get<ApiResponseDto<PageResponseDto<ChallengeResponseDto>>>('/api/v1/challenges', { params })
    return response.data.data!
  },

  getChallengeById: async (id: number): Promise<ChallengeResponseDto> => {
    const response = await http.get<ApiResponseDto<ChallengeResponseDto>>(`/api/v1/challenges/${id}`)
    return response.data.data!
  },

  createChallenge: async (data: ChallengeCreateRequestDto): Promise<ChallengeResponseDto> => {
    const response = await http.post<ApiResponseDto<ChallengeResponseDto>>('/api/v1/challenges', data)
    return response.data.data!
  },

  updateChallenge: async (id: number, data: ChallengeUpdateRequestDto): Promise<ChallengeResponseDto> => {
    const response = await http.put<ApiResponseDto<ChallengeResponseDto>>(`/api/v1/challenges/${id}`, data)
    return response.data.data!
  },
  ...
  getChallengeStats: async (id: number): Promise<ChallengeStatsDto> => {
    const response = await http.get<ApiResponseDto<ChallengeStatsDto>>(`/api/v1/challenges/${id}/stats`)
    return response.data.data!
  }
}
...
export const evidenceApi = {
  getEvidence: async (challengeId: number, params?: PageRequestDto): Promise<PageResponseDto<EvidenceResponseDto>> => {
    const response = await http.get<ApiResponseDto<PageResponseDto<EvidenceResponseDto>>>(`/api/v1/challenges/${challengeId}/evidences`, { params })
    return response.data.data!
  },
  ...
  createEvidence: async (data: EvidenceCreateRequestDto): Promise<EvidenceResponseDto> => {
    const response = await http.post<ApiResponseDto<EvidenceResponseDto>>('/api/v1/evidences', data)
    return response.data.data!
  },

  updateEvidence: async (id: number, data: { description?: string; metadata?: Record<string, any> }): Promise<EvidenceResponseDto> => {
    const response = await http.put<ApiResponseDto<EvidenceResponseDto>>(`/api/v1/evidences/${id}`, data)
    return response.data.data!
  },
  ...
  uploadEvidenceFile: async (file: File, evidenceId: number): Promise<string> => {
    ...
    const response = await http.post<ApiResponseDto<{ fileUrl: string }>>(`/api/v1/evidences/${evidenceId}/upload`, formData, {
...
export const validationApi = {
  getValidations: async (params?: PageRequestDto): Promise<PageResponseDto<ValidationResponseDto>> => {
    const response = await http.get<ApiResponseDto<PageResponseDto<ValidationResponseDto>>>('/api/v1/validations', { params })
    return response.data.data!
  },

  getValidationById: async (id: number): Promise<ValidationResponseDto> => {
    const response = await http.get<ApiResponseDto<ValidationResponseDto>>(`/api/v1/validations/${id}`)
    return response.data.data!
  },

  createValidation: async (data: ValidationCreateRequestDto): Promise<ValidationResponseDto> => {
    const response = await http.post<ApiResponseDto<ValidationResponseDto>>('/api/v1/validations', data)
    return response.data.data!
  },

  updateValidation: async (id: number, data: ValidationUpdateRequestDto): Promise<ValidationResponseDto> => {
    const response = await http.put<ApiResponseDto<ValidationResponseDto>>(`/api/v1/validations/${id}`, data)
    return response.data.data!
  },
  ...
  assignValidation: async (validationId: number, validatorId: number): Promise<ValidationResponseDto> => {
    const response = await http.post<ApiResponseDto<ValidationResponseDto>>(`/api/v1/validations/${validationId}/assign`, { validatorId })
    return response.data.data!
  }
}
...
export const validatorApi = {
  getValidators: async (params?: PageRequestDto): Promise<PageResponseDto<ValidatorResponseDto>> => {
    const response = await http.get<ApiResponseDto<PageResponseDto<ValidatorResponseDto>>>('/api/v1/validators', { params })
    return response.data.data!
  },

  getValidatorById: async (id: number): Promise<ValidatorResponseDto> => {
    const response = await http.get<ApiResponseDto<ValidatorResponseDto>>(`/api/v1/validators/${id}`)
    return response.data.data!
  },

  applyAsValidator: async (data: { specialty: string; certificationDocument?: string; experience?: string }): Promise<ValidatorResponseDto> => {
    const response = await http.post<ApiResponseDto<ValidatorResponseDto>>('/api/v1/validators/apply', data)
    return response.data.data!
  }
}
...
export const coachApi = {
  getCoaches: async (params?: PageRequestDto): Promise<PageResponseDto<CoachResponseDto>> => {
    const response = await http.get<ApiResponseDto<PageResponseDto<CoachResponseDto>>>('/api/v1/coaches', { params })
    return response.data.data!
  },
  ...
  applyAsCoach: async (data: { bio?: string; specialties: string[]; hourlyRate?: number; currency?: string }): Promise<CoachResponseDto> => {
    const response = await http.post<ApiResponseDto<CoachResponseDto>>('/api/v1/coaches/apply', data)
    return response.data.data!
  }
}
...
export const ratingApi = {
  ...
  getRatings: async (targetId: number, targetType: string, params?: PageRequestDto): Promise<PageResponseDto<RatingResponseDto>> => {
    const response = await http.get<ApiResponseDto<PageResponseDto<RatingResponseDto>>>(`/api/v1/ratings/${targetType}/${targetId}`, { params })
    return response.data.data!
  }
}
...
export const notificationApi = {
  getNotifications: async (params?: PageRequestDto): Promise<PageResponseDto<NotificationResponseDto>> => {
    const response = await http.get<ApiResponseDto<PageResponseDto<NotificationResponseDto>>>('/api/v1/notifications', { params })
    return response.data.data!
  },
...
export const invitationApi = {
  getInvitations: async (params?: PageRequestDto): Promise<PageResponseDto<InvitationResponseDto>> => {
    const response = await http.get<ApiResponseDto<PageResponseDto<InvitationResponseDto>>>('/api/v1/invitations', { params })
    return response.data.data!
  },

  createInvitation: async (data: InvitationCreateRequestDto): Promise<InvitationResponseDto> => {
    const response = await http.post<ApiResponseDto<InvitationResponseDto>>('/api/v1/invitations', data)
    return response.data.data!
  },
...
export const reportApi = {
  ...
  getReports: async (params?: PageRequestDto): Promise<PageResponseDto<ReportResponseDto>> => {
    const response = await http.get<ApiResponseDto<PageResponseDto<ReportResponseDto>>>('/api/v1/reports', { params })
    return response.data.data!
  }
}
