...
export const PRICING_COPY = {
  ...
  guarantee:
    "Garantía 30 días en primera compra (no renovaciones). Excluye uso intensivo manifiesto.",
  ...
  emails: {
    welcome:
      "Tienes acceso gratis 90 días sin tarjeta. El {fecha_fin} podrás elegir plan o seguir en Basic gratis.",
    reminder15:
      "En 15 días finaliza tu beta. Si quieres Pro, lo activas tú (sin sorpresas). Si no, pasas a Basic gratis.",
    reminder7:
      "En 7 días finaliza tu beta. Si quieres Pro, lo activas tú (sin sorpresas). Si no, pasas a Basic gratis.",
    reminder1:
      "Mañana finaliza tu beta. Si quieres Pro, lo activas tú (sin sorpresas). Si no, pasas a Basic gratis.",
  },
};
