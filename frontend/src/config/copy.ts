// IMPULSE  - Copy Text Configuration (Specification Compliant)
...
export const HERO_COPY = {
  ...
  // Beta messaging
  betaNotice:
    "IMPULSE está en beta abierta 90 días: sin tarjeta, sin cobros, sin renovación. Al finalizar, podrás elegir plan o seguir en Basic gratis.",

  // Legal footer (Section 19)
  legalFooter:
    "Al continuar aceptas Términos, Privacidad y Cookies. Cuando actives un plan de pago, podrás cancelar en 1 clic desde tu Portal.",
};
...
export const BILLING_COPY = {
  ...
  guarantee:
    "Garantía 30 días (cuando empieces a cobrar): primera compra, no renovaciones; excluye uso intensivo manifiesto.",

  // Billing disabled message
  billingDisabled:
    "¡Próximamente! Durante la beta de 90 días, todos los usuarios tienen acceso completo sin cobros.",
  ...
  plans: {
    basic: {
      ...
      tagline: "gratis",
      description:
        "hasta 2 retos activos · 3 validadores/reto · texto + 1 imagen · privacidad estándar · historial básico",
    },
    pro: {
      name: "Pro",
      tagline: "12,99 €/mes · 99 €/año",
      description:
        "retos/validadores ilimitados · multimedia completa · retos privados/equipo · stats avanzadas · exportación · soporte prioritario",
    },
    teams: {
      name: "Teams",
      tagline: "39,99 €/mes incluye 10; +4 €/miembro extra",
      description:
        "dashboard equipo · colaborativos · competiciones · reportes · roles y onboarding",
    },
    coach: {
      name: "Coach",
      tagline: "personalizado",
      description:
        "marketplace, 1-a-1, marca blanca, analíticas. (Desactivado hasta go-live fiscal)",
    },
  },
};
...
export const formatEmailBody = (
  template: string,
  userInfo: { nombre?: string; fecha_fin?: string },
): string => {
