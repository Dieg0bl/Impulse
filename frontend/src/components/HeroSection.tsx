...
const HeroSection: React.FC<HeroSectionProps> = ({ 
  ...
  return (
    <section className={`bg-gradient-to-br from-blue-600 to-purple-700 text-white py-20 px-4 ${className}`}>
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
            ...
            <p className="text-sm text-blue-200">La comunidad valida tu progreso de forma transparente</p>
          </div>
          
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
            <div className="text-3xl mb-2">🔒</div>
            <h4 className="font-semibold mb-1">Privado por Defecto</h4>
            <p className="text-sm text-blue-200">Tu información es privada salvo que decidas compartirla</p>
          </div>
        </div>
