    ...
    >
      ...
      <div className="p-6">
        ...
        {planId === "teams" && plan.teamConfig && (
          <div className="mb-4 p-3 bg-blue-50 rounded-lg">
            <p className="text-sm text-blue-800">
              <strong>{plan.teamConfig.included} miembros incluidos.</strong> Miembros adicionales:{" "}
              {formatPrice(plan.teamConfig.extraMemberPrice)}/mes cada uno.
            </p>
          </div>
        )}
        ...
        >
          ...
          {planId === "coach" &&
            (config.isCoachMarketEnabled ? "Aplicar como Coach" : "Próximamente")}
        </button>
